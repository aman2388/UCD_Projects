...
/**
 * Implementation of the AuldFellas insurance quotation auldfellas.service.
 * 
 * @author Rem
 *
 */
...
public class AFQService extends AbstractQuotationService {
	...
	public ResponseEntity<Quotation> createQuotation(@RequestBody ClientInfo info) throws URISyntaxException {
		...
		System.out.println("Check "+new ResponseEntity<>(quotation, headers, HttpStatus.CREATED));
