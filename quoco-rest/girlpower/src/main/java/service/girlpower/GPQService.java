...
/**
 * Implementation of the Girl Power insurance quotation auldfellas.service.
 * 
 * @author Rem
 *
 */
...
public class GPQService extends AbstractQuotationService {
	// All references are to be prefixed with an GP (e.g. DD001000)
	...
	public ResponseEntity<Quotation> createQuotation(@RequestBody ClientInfo info) throws URISyntaxException {
		...
		System.out.println("GIRLPOWER!!!!!!!!!!! URL:" + path);
